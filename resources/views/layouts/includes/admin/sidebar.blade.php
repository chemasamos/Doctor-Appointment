@php
    // Arreglo de íconos (sin la entrada duplicada y con un ejemplo adicional)
    $links = [
       [
          'name' => 'Dashboard',
...
<aside id="logo-sidebar"
    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
        <ul class="space-y-2 font-medium">
            ...
            {{-- Este bucle generará los enlaces dinámicos del arreglo $links --}}
                    ...
                    @else
                        <a href="{{ $link['href'] }}"
                           ...
                           <span class="w-6 h-6 inline-flex justify-center items-center text-gray-400">
                            ...
                            {{-- Pequeña corrección para consistencia: sin espacio en $link['name'] --}}
            ...
            {{-- CORRECCIÓN PRINCIPAL: El menú desplegable se movió FUERA del bucle @foreach --}}
            <li>
